...
mutation createUser ($city: String, $contact: String, $country: String, $email: String!, $password: String!, $username: String!,$firstname:String,$lastname:String) {
    createUser (city: $city, contact: $contact, country: $country, email: $email, password: $password, username: $username, firstname:$firstname,lastname:$lastname) {
        user {
            id
            password
            lastLogin
